...
/* $Id: wnhelp.c,v 1.12 2003/07/15 14:41:18 wn Exp $ */
...
\n\
Each domain synset is preceeded by \"CATEGORY\", \"REGION\", or \"USAGE\" to \n\
...
\n\
Each domain term synset is preceeded by \"CATEGORY TERM\", \"REGION TERM\", or \n\
